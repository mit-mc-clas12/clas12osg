...
def get_args():
	...
	argparser.add_argument('scardFile', metavar='scard', type=str, nargs='+',help='an integer for the accumulator')
	...
	argparser.add_argument('--t', action='store_true', help='Use table CLAS12TEST instead of default CLAS12OCR', default=False)
